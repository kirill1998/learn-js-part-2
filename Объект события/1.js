...
field.onclick = function(event){
 event = event || window.event ;
  ...
  else if ((event.clientX - box.left - parseInt(ball.width/2) - field.clientLeft )> (field.clientWidth - parseInt(ball.width)))
  {
  ...
  else  if( (event.clientY - box.top - parseInt(ball.height/2) -field.clientTop) > (field.clientHeight - parseInt(ball.height)) )
  {
